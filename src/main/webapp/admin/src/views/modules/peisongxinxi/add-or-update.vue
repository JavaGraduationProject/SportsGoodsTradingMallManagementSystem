<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="快递名称" prop="kuaidimingcheng">
          <el-input v-model="ruleForm.kuaidimingcheng" 
              placeholder="快递名称" clearable></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.kuaidimingcheng" label="快递名称" prop="kuaidimingcheng">
              <el-input v-model="ruleForm.kuaidimingcheng" 
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.fuzerenxingming" label="负责人姓名" prop="fuzerenxingming">
              <el-input v-model="ruleForm.fuzerenxingming" 
                placeholder="负责人姓名" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="负责人联系电话" prop="fuzerenlianxidianhua">
          <el-input v-model="ruleForm.fuzerenlianxidianhua" 
              placeholder="负责人联系电话" clearable></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.fuzerenlianxidianhua" label="负责人联系电话" prop="fuzerenlianxidianhua">
              <el-input v-model="ruleForm.fuzerenlianxidianhua" 
                placeholder="负责人联系电话" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
            ...
            continue;
                    ...
                    if(o=='fuzerenlianxidianhua'){
            this.ruleForm.fuzerenlianxidianhua = obj[o];
            continue;
          }
                    if(o=='xingbie'){
