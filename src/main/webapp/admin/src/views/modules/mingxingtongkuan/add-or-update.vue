  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.shangpinleibie" label="商品类别" prop="shangpinleibie">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.pinpai" label="品牌" prop="pinpai">
              <el-input v-model="ruleForm.pinpai" 
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.shuliang" label="数量" prop="shuliang">
              <el-input v-model="ruleForm.shuliang" 
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `mingxingtongkuan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.mingxingtongkuanCrossAddOrUpdateFlag = false;
                  this.parent.search();
