...
export default {
  ...
  methods: {
        ...
        for (var o in obj){
            ...
            continue;
                                ...
                                // 多级联动参数
                                          info(id) {
      this.$http({
        url: `discussmingxingtongkuan/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `discussmingxingtongkuan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.discussmingxingtongkuanCrossAddOrUpdateFlag = false;
                  this.parent.search();
